...
from bitbooster.operations.distance_operations import generic_index_with_lowest_sum, \
    SIGNATURE_RECTANGLE_DISTANCE_MATRIX, SIGNATURE_INDEX_WITH_LOWEST_SUM
...
def euclidean_index_with_lowest_sum(x_val, y_val):
    return generic_index_with_lowest_sum(x_val, y_val, rectangle_distance_matrix_euclidean_vanilla)
